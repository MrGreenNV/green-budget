...
import ru.averkiev.budget.enums.TransactionType;
import ru.averkiev.budget.exceptions.TransactionNotFoundException;
import ru.averkiev.budget.exceptions.TransactionTypeNotFound;
...
import ru.averkiev.budget.repositories.TransactionRepository;
...
import static ru.averkiev.budget.services.impl.FinancialAccountServiceImpl.findActiveAccountByIdOrElseThrow;
import static ru.averkiev.budget.services.impl.TransactionCategoryServiceImpl.findActiveCategoryByIdOrElseThrow;
